...
- 3ds Max version compatibility for the EDM plugin
- FBX export settings from Blender
- Common FBX-import gotchas in 3ds Max (User Defined Properties, scale, axis)
- Reset XForm and scale workflow in Max
- MAXScript patterns for batch operations
- Material slot handling across the FBX boundary
...
> *Previous: [Lighting and damage](04-lighting-damage.md) — Next: [Substance Painter (planned)](06-substance-painter.md)*
